...
public class CsvConverter {
    ...
    public void converter(String filepath) {
        ...
        try {
            writer = new FileWriter("C:\\Users\\DZJPG1\\Documents\\Projects\\assignement\\src\\main\\CSVFiles\\allrecords.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void convertSpecRecord (String filepath) {
        ...
        try {
            writer = new FileWriter("C:\\Users\\DZJPG1\\Documents\\Projects\\assignement\\src\\main\\CSVFiles\\SpecRecordsOnly.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
        for(Record specRecord:specRecordsList) {
    ...
    public void converterActionRecord(String filepath) {
        ...
        try {
            writer = new FileWriter("C:\\Users\\DZJPG1\\Documents\\Projects\\assignement\\src\\main\\CSVFiles\\ActionRecordsOnly.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
